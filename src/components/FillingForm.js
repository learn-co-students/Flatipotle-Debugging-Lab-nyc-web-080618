    ...
    <div className="inline fields ui centered grid">
      <div className="field">
        <div className="ui checkbox">
          <input id="white-rice" type="checkbox" value="White Rice" name="fillings" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="brown-rice" type="checkbox" value="Brown Rice" name="fillings" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="black-beans" type="checkbox" value="Black Beans" name="fillings" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="pinto" type="checkbox" value="Pinto Beans" name="fillings" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="veg" type="checkbox" value="Fajita Veggies" name="fillings" onChange={props.handleChange}/>
