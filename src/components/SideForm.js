    ...
    <div className="inline fields ui centered grid">
      <div className="field">
        <div className="ui checkbox">
          <input id="chips" type="checkbox" value="Chips" name="sides" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="chips-salsa" type="checkbox" value="Chips & Salsa" name="sides" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="chips-guac" type="checkbox" value="Chips & Guac" name="sides" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="chips-queso" type="checkbox" value="Chips & Queso" name="sides" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="tortila" type="checkbox" value="Tortilla" name="sides" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="taco" type="checkbox" value="Taco" name="sides" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="drink" type="checkbox" value="Fountain Drink" name="sides" onChange={props.handleChange}/>
