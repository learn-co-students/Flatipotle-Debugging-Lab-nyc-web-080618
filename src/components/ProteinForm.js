    ...
    <div className="inline fields ui centered grid">
      <div className="field">
        <div className="ui checkbox">
          <input id="barbacoa" type="checkbox" value="Barbacoa" name="protein" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="steak" type="checkbox" value="Steak" name="protein" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="chicken" type="checkbox" value="Chicken" name="protein" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="carnitas" type="checkbox" value="Carnitas" name="protein" onChange={props.handleChange}/>
      ...
      <div className="field">
        <div className="ui checkbox">
          <input id="sofritas" type="checkbox" value="Sofritas" name="protein" onChange={props.handleChange}/>
